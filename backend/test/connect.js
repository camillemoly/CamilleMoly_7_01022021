...
describe('POST api/auth/signup', () => {
  ...
  it.skip('should create an user account', (done) => {
    chai
      ...
      .end((err, res) => {
        ...
        res.body.should.have.property('message').eql('Compte créé !');
        done();
      });
  });
  // 2
  ...
  // 6
  it('should generate an error for first name and last name fields (contain a number)', (done) => {
    chai
      .request(app)
      .post('/api/auth/signup')
      .send({
  ...
  // 7
  it('should generate an error for first name and last name fields (contain a symbol)', (done) => {
    chai
      .request(app)
      .post('/api/auth/signup')
      .send({
  ...
  it('should generate an error because the account doesn\'t exist', (done) => {
    chai
      ...
      .end((err, res) => {
        ...
        res.body.should.have
          .property('error')
          .eql('L\'email renseigné n\'est associé à aucun compte!');
        done();
      });
  });
  // 3
