...
/******************** MODIFY USER ******************** /
 * Checks if the request contains a file and, if so, it deletes old profile picture to replace it by the new one
 * It returns an error if a field doesn't match with validator or regex
 * Otherwise it updates the user
 */
exports.modifyUser = (req, res) => {
  ...
  .then(user => {
    if (user.id !== userIdToken && isAdminToken == false) {
...
/******************** DELETE USER ******************** /
 * Searches all the likes of the user and deletes them,
 * then it searches all his comments and deletes them,
 * then it searches all his posts and deletes them,
 * then it deletes his profile picture and his account
 */
